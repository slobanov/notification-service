...
import ru.tinkoff.fintech.service.notification.service.notification.CardNumberMasker
import ru.tinkoff.fintech.service.notification.service.notification.NotificationMessageGeneratorImpl
...
class NotificationMessageGeneratorImplTest {
    ...
    fun `test generating message`() {
        ...
        assertEquals("Уважаемый, Сергей!\n" +
            "Спешим Вам сообщить, что на карту #####\n" +
            "начислен cashback в размере 54.45\n" +
            "за категорию BLACK.\n" +
            "Спасибо за покупку 2020-11-20T01:00", message)
    }
