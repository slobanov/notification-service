...
import ru.tinkoff.fintech.service.notification.service.notification.CardNumberMaskerImpl
...
class CardNumberMaskerImplTest {
    ...
    @Test
    fun `test masking null card number`() {
        val maskedCardNumber = observable.mask(null)
        assertEquals("", maskedCardNumber)
    }
